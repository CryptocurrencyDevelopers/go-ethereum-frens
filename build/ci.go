...
import (
	...
	"github.com/CryptocurrencyDevelopers/go-ethereum-frens/crypto/signify"
	"github.com/CryptocurrencyDevelopers/go-ethereum-frens/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/CryptocurrencyDevelopers/go-ethereum-frens/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/CryptocurrencyDevelopers/go-ethereum-frens/mobile")
